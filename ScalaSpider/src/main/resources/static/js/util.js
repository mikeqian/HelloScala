...
$(function () {
    ...
    //菜单标记
    $("#divTopMenu .selectd").closest(".item").addClass("active");
    $("#divTopMenu .selectd").closest(".TopCategory1").addClass("active").show();
    ...
    $("#divTopMenu  .TopCategory1").each(function () {
        if (!$(this).hasClass("active")) {
            $(this).hide();
        }
    });
    var index = $("#divTopMenu .selectd").closest(".TopCategory1").index() - 1;
    $("#selCategory1").val(index);

    //一,二级菜单展开收起
    $("#selCategory1").change(function () {
        var index = $("#selCategory1").val();
        $(".TopCategory1").removeClass("active").hide();
        $(".TopCategory1").eq(index).addClass("active").show();
    });
